...
<div class="container">
	<div class="row">
				<div class="profile-photo">
					<img class="center" class="img-responsive" src="PrototypeImages/WeeDaniel.jpg" alt="Profile Photo" width="100" height="100">
					
					<h3><b> Daniel O'Donnell </b></h3>
					<p> Senior Java Developer <br> Avaya <br> Galway, Ireland </p>
