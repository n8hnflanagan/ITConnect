...
include_once 'includes/dbh.inc.php';
	...
	if( empty($_SESSION['comp_id']))
		...
		exit();
				...
				$sql5="SELECT VacanciesId, VacTitle, VacDescription, VacLocation, VacDatePosted, VacClosureDate FROM itconnect.vacancies WHERE CompId =".$_SESSION['comp_id'].";";
				//echo $sql5;
							...
							echo '<div class="container">
										 <div class="row">
											<div class = "profile-photo" >';
												echo "<h3>Vacancy: ".$count."</h3>ALL FIELDS MUST BE UPDATED, 0 for no change. Dates must be entered";
										    echo '<form action="includes\editCurrVacancies.php" method="POST" autocomplete="on"> ';
											    ...
											    echo '<input type="text" class="form-control" name="VacTitle" placeholder="Change Company: '.$vacTitle.'">';
											    echo '</div>';
											    ...
											    echo '<input type="text" class="form-control" name="VacDesc" placeholder="Change Address: '.$vacDesc.'">';
											    echo '</div>';
											    ...
											    echo '<input type="text" class="form-control" name="VacLocation" placeholder="Change Contact Number Max 15 Chars: '.$vacLoc.'">';
											    echo '</div>';
											    ...
											    echo '<input type="date" class="form-control" name="VacDatePosted" placeholder="Change Contact Number Max 15 Chars: '.$vacLoc.'">';
											    echo '</div>';
											    ...
											    //echo '<input type="text" class="form-control" rows="6" name="Aboutme" placeholder="Change About Me: '.$userAboutMe.'">';
											    echo '<input type="date" class="form-control" name="VacClosureDate" placeholder="Change Contact Number Max 15 Chars: '.$vacClosureDate.'">';
											    echo '</div>';
