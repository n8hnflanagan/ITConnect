...
if (isset($_POST['submit']))
  {
              ...
              if ($fileSize < 1000000)
                {
                  ...
                  $sql = "UPDATE companies SET CompCoverPhotoFileLocation='".$fileDataBaseLoc."' WHERE CompId ='".$_SESSION['comp_id']."';";
                  mysqli_query($conn, $sql);
                  mysqli_close($conn);
                  header("Location: ../CompanyAccountPage.php?upload=success");
                } else{
    ...
    header("Location: ../CompanyAccountPage.php?postempty=fail");
  }
